...
<template>
  <div class="fixed left-0 top-0 bottom-0 bg-gray-900 py-4 px-2">
    <div class="h-full flex flex-col space-y-4 items-center">
      ...
      <div class="flex-none">
        <div class="w-8 h-8 bg-white rounded-lg cursor-pointer">
          <span class="icon w-full h-full p-2">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M21 11H6.414l5.293-5.293-1.414-1.414L2.586 12l7.707 7.707 1.414-1.414L6.414 13H21z"></path></svg>
          </span>
        </div>
      </div>
    ...
    <div class="absolute left-full right-4 bg-gray-900 p-2">
      <div class="w-8 h-8 bg-white rounded-lg cursor-pointer">
        <span class="icon w-full h-full p-2">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M21 11H6.414l5.293-5.293-1.414-1.414L2.586 12l7.707 7.707 1.414-1.414L6.414 13H21z"></path></svg>
        </span>
