...
<template>
  <div class="modal_menu transform translate-x-full z-50" :class="{'!translate-x-0': modalStore.menu}">
    ...
    <h1 class="text-4xl font-semibold pt-8 pb-12" style="color: var(--color-2);">Blog <span class="text-rose-500">.</span></h1>

    <BlogLayoutMenu></BlogLayoutMenu>
