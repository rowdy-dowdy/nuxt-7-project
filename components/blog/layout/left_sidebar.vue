<script setup lang="ts">
  ...
  const slide2_html = ref<HTMLElement | null>(null)
  var swiper2: Swiper | null = null

  onMounted(() => {
    if(slide2_html.value)
      swiper2 = new Swiper(slide2_html.value, {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        modules: [Navigation],
  ...
  <div>
    ...
    <section class="py-6">
      <div class="rounded-lg border p-6">
        ...
        <button class="blog-btn blog-btn-r mt-2 block w-full px-4 py-2.5">Sign Up</button>
    ...
    <section class="py-6">
      <div class="rounded-lg border p-6">
        ...
        <div class="mt-8">
          <div ref="slide2_html" class="swiper slide2">
