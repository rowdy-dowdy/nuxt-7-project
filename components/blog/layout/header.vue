  ...
  <header class="sticky top-0 left-0 w-full bg-white">
    <BlogLayoutContainer>
      <div class="flex items-center space-x-8 py-10">
        ...
        <div class="flex-auto flex items-center space-x-8">
...
<style>
  ...
  .button-icon {
    @apply icon w-12 h-12 rounded-full bg-gradient-to-b from-rose-400 via-rose-500 to-rose-400 bg-[length:auto_200%] hover:bg-[bottom_center] text-white p-3 shadow transition-all duration-300;
  }
</style>